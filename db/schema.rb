...
ActiveRecord::Schema.define(version: 20_170_406_110_809) do
  ...
  create_table 'comments', force: :cascade do |t|
    ...
    t.index ['slice_id'], name: 'index_comments_on_slice_id', using: :btree
  end
  ...
  create_table 'slice_types', force: :cascade do |t|
    t.string 'name',         null: false
    t.string 'display_name', null: false
  end
  ...
  create_table 'slices', force: :cascade do |t|
    ...
    t.integer  'slice_type_id'
    t.boolean  'translatable',      null: false
    t.text     'body',              null: false
    t.datetime 'created_at',        null: false
    t.datetime 'updated_at',        null: false
    t.index ['material_id'], name: 'index_slices_on_material_id', using: :btree
    t.index ['slice_type_id'], name: 'index_slices_on_slice_type_id', using: :btree
  end
  ...
  create_table 'translations', force: :cascade do |t|
    ...
    t.datetime 'created_at',    null: false
    t.datetime 'updated_at',    null: false
    t.index ['slice_id'], name: 'index_translations_on_slice_id', using: :btree
